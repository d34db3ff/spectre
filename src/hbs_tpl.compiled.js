...
templates['index.hbs'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!DOCTYPE html>\n<html>\n<head>\n    <meta charset=\"utf-8\" />\n    <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" />\n\n    <title>"
    ...
    + "</section>\n	    <section class=\"poweredby\">Proudly published with <a href=\"https://github.com/d34db3ff/spectre\">spectre</a> </br> <noscript>This website is JavaScript-Free™ </noscript></section>\n        </footer>\n\n    </div>\n\n</body>\n</html>\n\n";
...
templates['post.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <main class=\"content\" role=\"main\">\n            <article class=\""
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"post_class") : depth0), depth0))
    + "\">\n\n                <header class=\"post-header\">\n                    <h1 class=\"post-title\">"
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"title") : depth0), depth0))
    + "</h1>\n                    <section class=\"post-meta\">\n                        <time class=\"post-date\" datetime=\""
    + alias2(lookupProperty(helpers,"date").call(alias3,{"name":"date","hash":{"format":"YYYY-MM-DD","ctime":(depth0 != null ? lookupProperty(depth0,"published_at") : depth0)},"data":data,"loc":{"start":{"line":38,"column":58},"end":{"line":38,"column":105}}}))
    + "\">"
    + alias2(lookupProperty(helpers,"date").call(alias3,{"name":"date","hash":{"format":"YYYY/MM/DD","ctime":(depth0 != null ? lookupProperty(depth0,"published_at") : depth0)},"data":data,"loc":{"start":{"line":38,"column":107},"end":{"line":38,"column":154}}}))
    + "</time>\n                    </section>\n                </header>\n\n                <section class=\"post-content\">\n                    "
    + ((stack1 = alias1((depth0 != null ? lookupProperty(depth0,"html") : depth0), depth0)) != null ? stack1 : "")
  ...
  return "<!DOCTYPE html>\n<html>\n<head>\n    <meta charset=\"utf-8\" />\n    <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" />\n\n    <title>"
    ...
    + " clearfix\">\n                    <label class=\"menu-button icon-menu\" for=\"nav-switch\"><span class=\"word\">菜单</span></label>\n            </nav>\n        </header>\n\n"
    + ((stack1 = lookupProperty(helpers,"with").call(alias3,(depth0 != null ? lookupProperty(depth0,"post") : depth0),{"name":"with","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":31,"column":8},"end":{"line":57,"column":17}}})) != null ? stack1 : "")
    + "\n        <footer class=\"site-footer clearfix\">\n            <section class=\"copyright\"><a href=\""
    + alias2(alias1(((stack1 = (depth0 != null ? lookupProperty(depth0,"site") : depth0)) != null ? lookupProperty(stack1,"url") : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? lookupProperty(depth0,"site") : depth0)) != null ? lookupProperty(stack1,"title") : stack1), depth0))
    + "</a> &copy; "
    + alias2(lookupProperty(helpers,"date").call(alias3,{"name":"date","hash":{"format":"YYYY"},"data":data,"loc":{"start":{"line":60,"column":88},"end":{"line":60,"column":110}}}))
    + "</section>\n	    <section class=\"poweredby\">Proudly published with <a href=\"https://github.com/d34db3ff/spectre\">spectre</a> </br> <noscript>This website is JavaScript-Free™ </noscript></section>\n        </footer>\n\n    </div>\n\n</body>\n</html>\n";
},"usePartial":true,"useData":true});
})();
(function() {
...
Handlebars.partials['loop'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<article class=\"post no-image\">\n    <header class=\"post-header\">\n        <h2 class=\"post-title\"><a href=\""
    ...
    + "\n        <time class=\"post-date\" datetime=\""
    + alias2(lookupProperty(helpers,"date").call(alias1,{"name":"date","hash":{"format":"YYYY-MM-DD","ctime":(depth0 != null ? lookupProperty(depth0,"published_at") : depth0)},"data":data,"loc":{"start":{"line":17,"column":42},"end":{"line":17,"column":89}}}))
    + "\">"
    + alias2(lookupProperty(helpers,"date").call(alias1,{"name":"date","hash":{"format":"YYYY-MM-DD","ctime":(depth0 != null ? lookupProperty(depth0,"published_at") : depth0)},"data":data,"loc":{"start":{"line":17,"column":91},"end":{"line":17,"column":138}}}))
    + "</time>\n    </footer>\n</article>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"extra-pagination inner\">\n"
    ...
    + "</div>\n\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"paged_posts") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":7,"column":0},"end":{"line":20,"column":9}}})) != null ? stack1 : "")
    + "\n"
...
Handlebars.partials['pagination'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<nav class=\"pagination\" role=\"navigation\">\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"prev") : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":3,"column":4},"end":{"line":5,"column":11}}})) != null ? stack1 : "")
    + "    <span class=\"page-number\">第 "
    + alias3(alias2((depth0 != null ? lookupProperty(depth0,"current_page") : depth0), depth0))
    + " 页 &frasl; 共 "
    + alias3(alias2((depth0 != null ? lookupProperty(depth0,"total_pages") : depth0), depth0))
    + " 页</span>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"next") : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":7,"column":4},"end":{"line":9,"column":11}}})) != null ? stack1 : "")
    + "</nav>\n";
},"2":function(container,depth0,helpers,partials,data) {
    var lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return "        <a class=\"newer-posts\" href=\""
    + container.escapeExpression(lookupProperty(helpers,"page_url").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"prev") : depth0),{"name":"page_url","hash":{},"data":data,"loc":{"start":{"line":4,"column":37},"end":{"line":4,"column":54}}}))
    + "\">&larr; 上一页</a>\n";
  ...
  return "        <a class=\"older-posts\" href=\""
    + container.escapeExpression(lookupProperty(helpers,"page_url").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"next") : depth0),{"name":"page_url","hash":{},"data":data,"loc":{"start":{"line":8,"column":37},"end":{"line":8,"column":54}}}))
    + "\">下一页 &rarr;</a>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = lookupProperty(helpers,"with").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pagination") : depth0),{"name":"with","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":11,"column":9}}})) != null ? stack1 : "");
},"useData":true});
})();
}